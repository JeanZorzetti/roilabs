...
faq:
  ...
  - q: 'O que é o SLA de estoque e despacho?'
    a: 'É o acordo de nível de serviço que a loja precisa cumprir para manter a cadeira: ter o produto em estoque e conseguir despachar dentro do prazo combinado. Como a ROI Labs só é remunerada quando a venda acontece, ela precisa que o cliente qualificado encontre produto disponível e atendimento rápido. Se a loja não sustenta estoque e despacho, o lead qualificado se perde e o modelo pago-pelo-sucesso não se sustenta para nenhuma das partes.'
  ...
  - q: 'A exclusividade tem custo extra para o fornecedor?'
    a: 'Não. A exclusividade é parte do modelo Growth Partner, que não cobra custo fixo nem mensalidade. A ROI Labs banca a tecnologia e o tráfego e é remunerada por uma fração variável atrelada à venda. A cadeira exclusiva não é um upgrade pago; é a estrutura padrão do modelo, que alinha o interesse das duas partes.'
---
...
| Custo fixo | Zero (modelo Growth Partner) | — |
...
A cadeira de revestimentos de Goiânia hoje tem candidatura aberta. Veja [como o modelo funciona da candidatura ao contrato](/modelo/), rode o [simulador de receita](/simulador/) com o seu ticket e volume para ver quanto sobra depois do success fee — e, se a conta fechar, [candidate sua empresa à cadeira](/#candidatar).
