...
Quem monta um e-commerce do zero paga quatro blocos antes do primeiro pedido:

1. **Plataforma** — mensalidade de plataforma pronta ou desenvolvimento sob medida, mais domínio, certificado e manutenção.
2. **Catálogo** — foto própria de cada produto (exigência real do Google Shopping, como mostramos no [passo a passo do Merchant Center](/blog/google-shopping-loja-material-construcao/)), descrição, preço e cadastro item a item.
3. **Integrações** — meio de pagamento, cálculo de frete (crítico em produto pesado ou volumoso), emissão fiscal.
4. **Tráfego** — o bloco mais subestimado. Site publicado sem investimento em mídia ou SEO é uma loja em rua sem movimento. SEO orgânico leva de 3 a 6 meses para maturar; mídia paga cobra por clique desde o primeiro dia.

Depois do lançamento o CAPEX vira OPEX: mensalidades, mídia contínua, atualização de catálogo, suporte. Tudo isso corre independente de a loja vender ou não — é custo fixo por definição.
...
A conta do polo tem três linhas:
...
| De quem é o cliente | Seu | Seu — o pedido fecha no seu WhatsApp ou balcão |

## Quando o e-commerce próprio ainda é o caminho certo?

O e-commerce próprio ainda é o caminho certo em alguns casos: marca própria forte com demanda direta, catálogo nacional (não local), margem que comporta mídia paga contínua e time interno para operar tudo isso. O polo é desenhado para o caso oposto e muito mais comum: **fornecedor regional com produto bom e nenhuma presença de busca**, para quem o custo de aprender e bancar a captação sozinho não se paga.
...
O modelo completo — exclusividade de cadeira por nicho, fases de maturação do SEO, o que a ROI Labs assume e o que fica com o fornecedor — está na página do [modelo Growth Partner](/modelo/), e a comparação com contratar uma agência está em [Growth Partner vs agência](/blog/growth-partner-vs-agencia-revestimentos/). Se a conta do simulador fechou para o seu ticket e volume, o passo seguinte é [candidatar sua empresa à cadeira do seu nicho](/#candidatar).
