...
3. **Integrações** — meio de pagamento, cálculo de frete (crítico em produto volumoso como revestimento), emissão fiscal.
4. **Tráfego** — o bloco mais subestimado. Site publicado sem investimento em mídia ou SEO é uma loja em rua sem movimento. SEO orgânico leva de 3 a 6 meses para maturar; mídia paga cobra por clique desde o dia um.
...
O modelo completo — exclusividade de cadeira por nicho, fases de maturação do SEO, o que a ROI Labs assume e o que fica com o fornecedor — está descrito na página do [modelo Growth Partner](/modelo/), e a comparação com o caminho de contratar uma agência está em [Growth Partner vs agência](/blog/growth-partner-vs-agencia-revestimentos/). Se a conta do simulador fechou para o seu ticket e volume, o passo seguinte é [candidatar sua empresa à cadeira do seu nicho](/#candidatar).
